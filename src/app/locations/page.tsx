...
export const metadata: Metadata = {
  ...
  description:
    "Cardinal Foundation Services serves DFW for residential and commercial work, the Houston area for residential and commercial foundation repair, and Texas for larger commercial and structural projects.",
