...
const data: ServicePageData = {
  ...
  heroImage: { src: "/images/tilt-wall-panel-joint-separation.webp", alt: "Tilt wall panel joint separation documented during a structural evaluation", width: 1440, height: 1920 },
  intro: [
