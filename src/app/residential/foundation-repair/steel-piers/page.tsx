...
export const metadata: Metadata = {
  title: { absolute: "Steel Piers for Foundation Repair in DFW & Houston | Cardinal" },
  description:
  ...
  openGraph: { images: [{ url: "/images/steel-pier-jobsite-lewisville.webp", width: 1400, height: 1050 }], },
};
...
const data: ServicePageData = {
  ...
  heroImage: { src: "/images/steel-pier-jobsite-lewisville.webp", alt: "Steel pier installation at a Lewisville multifamily property", width: 1400, height: 1050 },
  intro: [
  ...
  sections: [
    ...
    },
    {
      ...
      img: { src: "/images/steel-bracket-v2.webp", alt: "Steel pier bracket installation" },
      paras: [
    ...
    },
    {
      ...
      img: { src: "/images/steel-diagram-v2.webp", alt: "Steel pier system cutaway diagram" },
      paras: [
