...
export const metadata: Metadata = {
  title: { absolute: "Pier & Beam Foundation Repair in DFW & Houston | Cardinal" },
  description:
...
const data: ServicePageData = {
  ...
  sections: [
    ...
    },
    {
      ...
      img: { src: "/images/pier-and-beam-foundation-cross-section.webp", alt: "Cutaway rendering of a pier and beam foundation with concrete piers supporting the beam and floor framing" },
      paras: [
