...
const W_PROJECTS: WProject[] = [
  ...
  { t: "Multifamily Foundation Repair, Austin", cat: "Multifamily", loc: "Austin, TX", scope: ["Steel Piers", "Hillside", "Cast-Iron Coordination"], d: "High-volume pier installation on a hillside property, coordinated around aging cast-iron plumbing and occupied units.", href: "/projects/multi-family-foundation-repair-in-austin-tx/", img: "/images/project-austin-hero.webp" },
