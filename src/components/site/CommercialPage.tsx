...
const C_SERVICES = [
  ...
  { n: "02", t: "Concrete Lifting & Floor Leveling", href: "/commercial/concrete-lifting/", d: "Settled warehouse slabs and commercial floors raised back to grade with polyurethane foam or mudjacking.", items: ["Warehouse Slab Foundation Repair", "Concrete Leveling", "Slab Lifting", "Void Filling"], img: "/images/commhub-lifting-v2.webp", imgAlt: "Leveled municipal concrete after lifting" },
  { n: "03", t: "Commercial Concrete & Tilt-Wall", href: "/commercial/concrete-construction/", d: "Structural slab pours, tilt-wall panel work, and structural crack repair.", items: ["Structural Slab Pours", "Tilt-Wall Panels", "Structural Crack Repair", "Expansion Joints"], img: "/images/project-tiltresto-01.webp", imgAlt: "Tilt-wall panel work at a commercial building" },
  { n: "04", t: "Structural Retaining Walls", href: "/commercial/retaining-walls/", d: "Tieback anchors and structural wall work that manage load, slope, and lateral pressure.", items: ["Tieback Anchors", "Structural Wall Repair", "Wall Replacement"], img: "/images/commhub-retaining-v2.webp", imgAlt: "Stone retaining wall construction" },
  { n: "05", t: "Commercial Drainage & Stormwater", href: "/commercial/drainage/", d: "Water management that protects the slab, footings, and building envelope.", items: ["French Drains", "Perimeter Drainage", "Stormwater Management", "Grading"], img: "/images/commhub-drainage-v2.webp", imgAlt: "Commercial drainage gravel channel" },
  { n: "06", t: "Earthwork & Site Grading", href: "/new-construction/earthwork-grading/", d: "Site preparation and grading that corrects how water moves across the property.", items: ["Cut & Fill", "Site Grading", "Soil Preparation"], img: "/images/site-grading-telehandler-building-pad.webp", imgAlt: "Telehandler on a graded building pad" },
];
function CServices() {
  return (
