...
const R_SERVICES: { n: string; t: string; d: string; items: string[]; img: string; imgAlt?: string; feature?: boolean; href?: string }[] = [
  ...
  { n: "02", t: "Large Retaining Walls", href: "/residential/retaining-walls/", d: "Tieback anchors, structural rebuilds, and replacement for walls that hold back real load.", items: ["Tieback Anchors", "Structural Rebuilds", "Wall Replacement"], img: "/images/reshub-retaining.webp", imgAlt: "Large residential retaining wall" },
  { n: "03", t: "Concrete Lifting & Leveling", href: "/residential/concrete-leveling/", d: "Settled slabs, driveways, and pool decks raised back to grade with polyurethane foam or mudjacking.", items: ["House Lifting", "Driveways & Pool Decks", "Slab Lifting", "Void Filling"], img: "/images/reshub-lifting.webp", imgAlt: "Residential concrete lifting and leveling" },
  { n: "04", t: "Large & Custom Home Foundations", href: "/residential/foundation-repair/", d: "Foundation work for large and custom homes, where the repair has to respect the house.", items: ["Pier & Beam", "Slab Foundations", "Custom Home Repair"], img: "/images/reshub-custom.webp", imgAlt: "Custom home foundation work" },
];
function RServices() {
  return (
    ...
    <section style={{ background: "var(--red)", padding: "54px 0" }}>
      <div className="wrap" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 26, flexWrap: "wrap" }}>
        ...
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
          <a href="/request/" className="btn" style={{ background: "#fff", color: "var(--ink)", border: 0 }}>Book a free home inspection <Arrow s={15} /></a>
